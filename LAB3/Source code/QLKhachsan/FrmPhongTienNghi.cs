...
namespace QLKhachsan.Forms
{
    public partial class FrmPhongTienNghi : Form
    {
        ...
        public FrmPhongTienNghi()
        {
            ...
            btnThemTienNghi.Click += btnThemTN_Click;
        ...
        private void Frm_Load(object a, EventArgs e)
        {
            ...
            cboNV.DisplayMember = "TenNV"; // Đồng bộ với tên cột Nhân viên
        ...
        void H(KetQuaXuLy k)
        {
            MessageBox.Show(k.ThongBao, "Thông báo", MessageBoxButtons.OK, k.ThanhCong ? MessageBoxIcon.Information : MessageBoxIcon.Error);
            if (k.ThanhCong) Tai();
        }
